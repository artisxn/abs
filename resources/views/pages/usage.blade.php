...
@section('content')
  ...
  <p>最近更新されたアイテムから一定数の範囲を調査。ランキング1000位以内。履歴の価格が前回と比べて40%以上増減してる場合に通知。</p>
  ...
  <p>現時点では無料で使えます。
    ...
    <del>データ量がどうしようもならないサイズになってきたので有料プラン始めました。</del>
    アソシエイトの収益でここのサーバー費用にはなりそうなので個人向け有料プランは終了。自社サーバーで動かしたい法人向けのみ受け付けます。
  </p>
