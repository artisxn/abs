...
@section('title', 'APIドキュメント | ')

@section('content')

  <h1 class="uk-heading-divider">APIドキュメント</h1>
  ...
  <h2 class="uk-heading-line"><span>【ワールド】商品リストを取得</span></h2>
  ...
  <h2 class="uk-heading-line"><span>【ワールド】個別の商品データを取得</span></h2>
  ...
  <h2 class="uk-heading-line"><span>【ワールド】商品データを即時更新</span></h2>
  ...
  <h2 class="uk-heading-line"><span>【ワールド】商品リスト（新着）を取得</span></h2>
