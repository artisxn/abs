  ...
  <div class="uk-section  uk-padding">
    ...
    <form action="{{ route('settings.store') }}" method="post" class="uk-form-horizontal">
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input name="special_key" value="{{ request()->user()->special_key }}" class="uk-input" type="text"
                 placeholder="特典キー">
          <small class="uk-text-muted"><a href="https://enty.jp/kawax" target="_blank">Enty</a>の支援特典。キーは不定期に変更されます。</small>
      ...
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input name="api_token" value="{{ empty(request()->user()->api_token) ? str_random(60) : request()->user()->api_token }}" class="uk-input" type="text"
                 placeholder="APIトークン">
